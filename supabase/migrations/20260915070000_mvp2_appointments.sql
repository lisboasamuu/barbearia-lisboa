...
begin
  ...
  perform pg_advisory_xact_lock(hashtext('barbearia-lisboa-schedule'));
...
comment on table public.appointments is 'Barbearia Lisboa appointments. Timestamps are UTC; business rules use America/Sao_Paulo.';

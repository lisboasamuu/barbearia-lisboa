    ...
    return (
      <section className="booking-card text-center" aria-live="polite">
        ...
        <p className="mx-auto mt-6 max-w-lg leading-7 text-muted">
          Se precisar falar com a barbearia ou alterar seu horário, use o WhatsApp {business.whatsappDisplay}.
        </p>
        <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
          ...
          <Link className="button-secondary justify-center" href="/barbearia-lisboa/">Voltar ao site</Link>
        </div>
      </section>
    );
  }
  ...
  return (
    <section className={`booking-card ${compact ? "booking-card-compact" : ""}`}>
      ...
      <div className="mt-7 min-h-[20rem]">
        {step === 0 && (
          <div>
            <h2 className="form-title">Qual serviço você procura?</h2>
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {services.map((service) => (
                  <button key={service.id} type="button" className="choice-card text-left" onClick={() => chooseService(service.id)}>
                    ...
                    <span>{service.description || "Atendimento personalizado pela Barbearia Lisboa."}</span>

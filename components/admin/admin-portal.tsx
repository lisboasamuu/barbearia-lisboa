    ...
    return (
      <main className="grid min-h-svh place-items-center bg-aqua-soft p-4">
        <section className="booking-card w-full max-w-md">
          <Link className="brand-mark rounded-md focus-ring" href="/barbearia-lisboa/">
          ...
          {!getSupabaseClient() ? (
            <Link className="button-secondary mt-6 justify-center" href="/barbearia-lisboa/">Voltar ao site</Link>
          ) : (
    ...
    <main className="min-h-svh bg-canvas">
      <header className="border-b border-ink/10 bg-white">
        <div className="container-shell flex min-h-16 items-center gap-3 py-3">
          <Link className="brand-mark mr-auto rounded-md focus-ring" href="/barbearia-lisboa/">
            <BrandLockup priority />
          </Link>
      ...
      <div className="container-shell py-6 sm:py-9">
        <div className="mb-6">
          ...
          <h1 className="mt-2 font-serif text-3xl text-ink sm:text-4xl">Gestão da agenda</h1>
        </div>
